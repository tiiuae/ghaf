      ...
      theming = {
        ...
        iconTheme = {
          package = mkOption {
            ...
            description = ''
              Nixpkgs attribute name of the icon theme package.

              Default license: GNU General Public License v3.0
              https://github.com/PapirusDevelopmentTeam/papirus-icon-theme#license
            '';
          };
          light = mkOption {
            type = types.str;
        ...
        fonts = {
          sansSerif = {
            package = mkOption {
              ...
              default = "inter";
              description = ''
                Nixpkgs attribute name of the sans-serif font package.

                Default license: SIL Open Font License 1.1
          ...
          monospace = {
            package = mkOption {
              ...
              description = ''
                Nixpkgs attribute name of the monospace font package.
          ...
          emoji = {
            package = mkOption {
              ...
              description = ''
                Nixpkgs attribute name of the emoji font package.
