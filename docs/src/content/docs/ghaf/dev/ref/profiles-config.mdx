...
1. Create your own configuration file using [modules/profiles/mvp-user-trial.nix](https://github.com/tiiuae/ghaf/blob/main/modules/reference/profiles/mvp-user-trial.nix) as a reference.
