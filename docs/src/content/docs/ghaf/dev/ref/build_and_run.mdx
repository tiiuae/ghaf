...
<Aside type="caution">
  [Cross-compilation](/ghaf/dev/ref/cross_compilation) support is currently
  under development and not available for the building process.
</Aside>
...
| ----------------------- | ------------ | --------------------------------------------------------------------------------------------- |
| Virtual Machine         | x86_64       | [Running Ghaf Image for x86 VM (ghaf-host)](#running-ghaf-image-for-x86-vm-ghaf-host)         |
| Generic x86 Сomputer    | x86_64       | [Running Ghaf Image for x86 Computer](#running-ghaf-image-for-x86-computer)                   |
| Lenovo X1 Carbon Gen 11 | x86_64       | [Running Ghaf Image for Lenovo X1](#running-ghaf-image-for-lenovo-x1)                         |
| NVIDIA Jetson AGX Orin  | AArch64      | [Ghaf Image for NVIDIA Jetson Orin AGX](#ghaf-image-for-nvidia-jetson-orin-agx)               |
| NXP i.MX 8MP-EVK        | AArch64      | [Building Ghaf Image for NXP i.MX 8MP-EVK](#building-ghaf-image-for-nxp-imx-8mp-evk)          |
| MICROCHIP icicle-kit    | RISCV64      | [Building Ghaf Image for Microchip Icicle Kit](#building-ghaf-image-for-microchip-icicle-kit) |
