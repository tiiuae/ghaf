...
| Build | Ghaf and ghaf-givc revisions, target, version, generation, manifest SHA-256 |
...
Inspect the manifest system, build-system, target, and generation, and retain
build logs. Do not flash an NX with AGX artifacts.
