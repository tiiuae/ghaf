---
title: "NVIDIA Jetson AGX Orin: Boot and Power Management Processor Virtualization"
---
...
<Aside type="tip">
  UARTA is an UART unit with a port A connection. For more information, see
  [UART
  Connections](/ghaf/dev/technologies/nvidia_agx_pt_uart#uart-connections).
</Aside>
