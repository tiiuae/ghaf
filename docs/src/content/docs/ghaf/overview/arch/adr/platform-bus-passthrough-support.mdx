---
title: rust-vmm—Bus Passthrough Support for Rust VMMs
sidebar:
  badge:
    text: Proposed
    variant: caution
...
<Aside>
  *rust-vmm* is an open-source project that empowers the community to build
  custom Virtual Machine Monitors (VMMs) and hypervisors. For more information,
  see https://github.com/rust-vmm/community .
</Aside>
