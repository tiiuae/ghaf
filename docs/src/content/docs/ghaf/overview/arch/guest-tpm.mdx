...
- The [admin VM](/ghaf/modules/microvm/sysvms/adminvm.nix) takes the role of hosting the swtpm instances. This reduces the footprint of running an additional VM.
