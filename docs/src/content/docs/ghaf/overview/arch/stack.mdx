...
![Stack!](@assets/ghaf/stack.drawio.png "Ghaf Stack")
...
The Ghaf project provides the reference minimal host with user space as defined in the [Minimal Host](/ghaf/overview/arch/adr/minimal-host).
...
| -------------- | ------------------------------------ | ----------------------------------------------- |
| Networking     | [Yes](/ghaf/overview/arch/adr/netvm) | Partial                                         |
