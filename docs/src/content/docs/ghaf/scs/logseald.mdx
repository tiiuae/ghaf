...
The standard laptop and Orin profiles enable auditing independently of FSS.
Debug and release global profiles enable it for guests, including app VMs and
the IDS VM. Minimal profiles retain their audit-disabled default. Disabling FSS
