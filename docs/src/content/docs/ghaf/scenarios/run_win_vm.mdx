---
title: Running Windows 11 in VM on Ghaf
---

You can run Windows 11 in a VM on Ghaf with NVIDIA Jetson Orin AGX (ARM64) or Generic x86 device. This method uses [QEMU](https://www.qemu.org/) as VMM. For information on how to build and run a Ghaf image, see [Build and Run](/ghaf/dev/ref/build_and_run).

![Windows 11 in VM](@assets/ghaf/windows_in_vm.png)
