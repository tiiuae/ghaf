...
let
  ...
  generateCrossFromX86_64 = tgt: let
    hostConfiguration = tgt.hostConfiguration.extendModules {
  ...
  generateFlashScript = tgt: mkFlashScript {
    inherit nixpkgs;
    inherit (tgt) hostConfiguration;
    inherit jetpack-nixos;
  };

  generateFlashQSPI = tgt: mkFlashScript {
    inherit nixpkgs;
    hostConfiguration = tgt.hostConfiguration.extendModules {
...
in
{
  flake = {
    nixosConfigurations = {
      ...
      nvidia-jetson-orin-agx-release-nodemoapps = nvidia-jetson-orin-agx-release-nodemoapps.hostConfiguration;
      nvidia-jetson-orin-nx-debug-nodemoapps = nvidia-jetson-orin-nx-debug-nodemoapps.hostConfiguration;
      nvidia-jetson-orin-nx-release-nodemoapps = nvidia-jetson-orin-nx-release-nodemoapps.hostConfiguration;

      # Cross-compilation configurations
      nvidia-jetson-orin-agx-debug-from-x86_64 = nvidia-jetson-orin-agx-debug-from-x86_64.hostConfiguration;
      nvidia-jetson-orin-agx-release-from-x86_64 = nvidia-jetson-orin-agx-release-from-x86_64.hostConfiguration;
      nvidia-jetson-orin-nx-debug-from-x86_64 = nvidia-jetson-orin-nx-debug-from-x86_64.hostConfiguration;
      nvidia-jetson-orin-nx-release-from-x86_64 = nvidia-jetson-orin-nx-release-from-x86_64.hostConfiguration;

      # Cross-compilation nodemoapps configurations
      nvidia-jetson-orin-agx-debug-nodemoapps-from-x86_64 = nvidia-jetson-orin-agx-debug-nodemoapps-from-x86_64.hostConfiguration;
      nvidia-jetson-orin-agx-release-nodemoapps-from-x86_64 = nvidia-jetson-orin-agx-release-nodemoapps-from-x86_64.hostConfiguration;
      nvidia-jetson-orin-nx-debug-nodemoapps-from-x86_64 = nvidia-jetson-orin-nx-debug-nodemoapps-from-x86_64.hostConfiguration;
      nvidia-jetson-orin-nx-release-nodemoapps-from-x86_64 = nvidia-jetson-orin-nx-release-nodemoapps-from-x86_64.hostConfiguration;
    };
    ...
    packages = {
      ...
      x86_64-linux = {
        ...
        nvidia-jetson-orin-agx-debug-nodemoapps-from-x86_64 = nvidia-jetson-orin-agx-debug-nodemoapps-from-x86_64.package;
        nvidia-jetson-orin-agx-release-nodemoapps-from-x86_64 = nvidia-jetson-orin-agx-release-nodemoapps-from-x86_64.package;
        nvidia-jetson-orin-nx-debug-nodemoapps-from-x86_64 = nvidia-jetson-orin-nx-debug-nodemoapps-from-x86_64.package;
        nvidia-jetson-orin-nx-release-nodemoapps-from-x86_64 = nvidia-jetson-orin-nx-release-nodemoapps-from-x86_64.package;
