  ...
  audiovmBaseConfiguration = {
    imports = [
      ...
      ({
        ...
        # Enable and allow TCP connection from localhost and host only
        hardware.pulseaudio.tcp.enable = true;
        hardware.pulseaudio.tcp.anonymousClients.allowedIpRanges = ["127.0.0.1" "192.168.101.2"];
        hardware.pulseaudio.extraConfig = ''
          load-module module-native-protocol-tcp auth-ip-acl=127.0.0.1;192.168.101.2
