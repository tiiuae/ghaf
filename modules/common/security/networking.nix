...
in
{
  ...
  config.boot.kernel.sysctl = lib.mkMerge [
    ...
    (lib.mkIf (cfg.prevent-syn-flooding && cfg.enable) {
    ...
    (lib.mkIf (cfg.ignore-source-routed-ippackets && cfg.enable) {
