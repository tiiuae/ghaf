...
# Jetson Orin AGX/NX devices. Injected into sdimage-method flash targets via
# extendModules in targets/nvidia-jetson-orin/flake-module.nix — NOT imported by
# the base config, so upstream sd-image.nix is absent from initrd configs.
#
...
# flashed to external disk. NVIDIA's edk2 does not seem to care too much about
