  ...
  comms = {
    ...
    applications = [
      ...
      }
      {
        ...
        icon = "slack";
        command = "google-chrome-stable --disable-gpu --disable-software-rasterizer --enable-features=UseOzonePlatform --ozone-platform=wayland --app=https://app.slack.com/client --profile-directory=SlackProfile ${config.ghaf.givc.idsExtraArgs}";
      }
      {
        name = "Zoom";
        description = "Zoom Videoconferencing Application";
        icon = "Zoom";
        command = "google-chrome-stable --disable-gpu --disable-software-rasterizer --enable-features=UseOzonePlatform --ozone-platform=wayland --app=https://app.zoom.us/wc/home --profile-directory=ZoomProfile ${config.ghaf.givc.idsExtraArgs}";
      }
    ];
    extraModules = [
      {
