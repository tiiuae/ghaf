...
}:
{
  chrome = {
    ...
    applications =
      ...
      ++ (lib.optionals config.ghaf.reference.services.wireguard-gui.enable [
        {
    ...
    extraModules = [
      {
        ...
        ghaf.reference.services.wireguard-gui.enable = config.ghaf.reference.services.wireguard-gui.enable;
