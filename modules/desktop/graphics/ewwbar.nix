...
in
{
  config = lib.mkIf cfg.enable {
    ...
    # - widgets: Defines the widgets that will be used in the windows, such as system tray, clock, etc.
    # - windows: Specifies the windows that can be opened by the user or are open by default, such as bar, calendar, quick-settings, etc.
