...
# SPDX-License-Identifier: Apache-2.0
{
  ...
  authorizedKeys =
    [
      ...
      # So GUIVM can establish ssh-connection with the host without a password
    ]
    ++ lib.optional pkgs.stdenv.isx86_64 (builtins.readFile "${pkgs.waypipe-ssh}/keys/waypipe-ssh.pub");
in
  with lib; {
    ...
    config = mkIf cfg.enable {
      ...
      services.openssh.extraConfig = pkgs.dbus-over-ssh.host.sshdConfigExtra;
